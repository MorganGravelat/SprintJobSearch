...
//_____________________________
	...
	public void printCheck(String name) {
		int index = searchByName(name);
		if (index != -1 && list[index] instanceof Payable)
			((Payable)list[index]).printCheck();
		else {
...
public class Driver {
	...
	public static void main(String[] args) {
		...
		c.hire(new Volunteer("Jimson Jocabby"));
		...
		//c.printList();
		c.printCheck("William Supervisor");
...
class Volunteer extends Employee {
	public void volunteering () {
		System.out.println(" Valenteering....");
	}
...
//______________________________
class HourlyPaid extends Employee implements Payable { // HourlyPaid is a an Employee
...
//_____________________
class SalaryPaid extends Employee implements Payable {
